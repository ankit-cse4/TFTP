...
bool TFTPClient::sendRRQPacket(int clientSocket, struct sockaddr_in serverAddress) {
...
bool TFTPClient::sendWRQPacket(int clientSocket, struct sockaddr_in serverAddress) {
